module TranspilerTest.Parser.Value
                  ...
                  Concrete(
                      Sub(
                          ...
                          Infix(
                              ...
                              LogicalAnd,
                              Infix(VName(ASimple("i", pos 4 50 92 f4)), LessThan, ValueLiteral(VInt 5, pos 4 54 96 f4))
                          )
                      )
                  ))
               ...
               [ ExplicitValue(
                     ...
                     ValueExpression.VArray(
                         [ ValueLiteral(VInt(1), pos 7 35 194 f4)
                           ...
                           Infix(ValueLiteral(VInt(3), pos 7 44 203 f4), Plus, ValueLiteral(VInt(1), pos 7 48 207 f4)) ]
                     )
                 ) ]
           ) ] |] ]

[<TestCaseSource(nameof input)>]
let TestValueNat (source: string) (expected: Scheme) =
