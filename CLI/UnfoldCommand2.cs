...
internal static class UnfoldCommand2
{
    public static void AddUnfoldCommand2(this RootCommand rootCommand)
    {
        var arg = new Argument<FileInfo>("specification")
        {
            Description = "The file to process"
        };
        var unfoldCommand = new Command("unfold2")
        {
    ...
    private static void UnfoldSpecification(bool debug, FileInfo? file)
    {
        ...
        try
        {
            ...
            var (_, unfoldedDeclarations) = Transpiler.Transpiler.transpile2(schemeName, declarations);
